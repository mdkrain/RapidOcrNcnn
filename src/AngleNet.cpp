...
AngleNet::~AngleNet() { net.clear(); }

void AngleNet::setNumThread(int numOfThread) { numThread = numOfThread; }
...
Angle AngleNet::getAngle(cv::Mat &src) {
  ncnn::Mat input = ncnn::Mat::from_pixels(src.data, ncnn::Mat::PIXEL_RGB,
                                           src.cols, src.rows);
